...
class SittingPlanViewController: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    @IBOutlet var totalGuestsSeatedLabel: UILabel!
    ...
    func totalGuests(){
        let partner1 = partner1Label.text
        let partner2 = partner2Label.text
        let totalGuests = partner1!.number + partner2!.number
        totalGuestsSeatedLabel.text = "Total seated guests \(totalGuests)"
