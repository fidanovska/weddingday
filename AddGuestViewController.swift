...
class AddGuestViewController: UIViewController {
    ...
    func addGuest(){
        ...
        let guest = ["id": key,
                     ...
                     "guestFamilyName": guestFamilyNameTextField.text! as String, "guestEmail": guestEmailTextField.text! as String, "guestPhoneNumber": guestPhoneNumberTextField.text! as String, "partnerSide" :  partnerSide, "tableStatus" : tableStatus, "age" : age, "menu" : menu, "attending" : attending, "invited" : invited]
